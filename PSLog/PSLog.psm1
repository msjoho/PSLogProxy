...
If ($PSLogFeature | Where-Object Enabled) {
    Write-Verbose -Verbose -Message "PSLog Module activated on $($env:COMPUTERNAME) with $($env:USERNAME) (Enabled Feature$(if(($PSLogFeature | Where-Object Enabled).Count -gt 1){"s"}): $(($PSLogFeature | Where-Object Enabled).Name -join ", ""))"
}
